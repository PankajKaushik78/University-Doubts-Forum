...
class DoubtsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create doubt" do
    assert_difference('Doubt.count') do
      post doubts_url, params: { doubt: { description: @doubt.description, escalate_count: @doubt.escalate_count, is_resolved: @doubt.is_resolved, title: @doubt.title } }
    end
  ...
  test "should update doubt" do
    patch doubt_url(@doubt), params: { doubt: { description: @doubt.description, escalate_count: @doubt.escalate_count, is_resolved: @doubt.is_resolved, title: @doubt.title } }
